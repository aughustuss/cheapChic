...
import Banner1 from '@/public/images/banneroferta.png'
import Banner2 from '@/public/images/bannerprimavera.png'
        ...
        <>
            <Slider {...settings} className='overflow-hidden overflow-x-hidden font-body' >
                <section className='h-screen relative bg-quartiary'>
                    <Image alt="Banner 1" src={Banner1} className='absolute z-0  object-cover h-full' />
                ...
                <section className='text-primarypt-24 bg-tertiary h-screen px-2 relative' >
                    <Image alt="Banner 2" src={Banner2} className='absolute object-cover h-full z-0' />
